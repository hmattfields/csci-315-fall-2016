...
\begin{center}
{\bf Lab 00: Basics of C++, Git, and the Command Line
}
\end{center}
...
\textbf{Note:} A lot of instruction is missing from this assignment.  Please refer to the class videos for more information.
...
For all other assignments you are in charge testing.  For lab00, a makefile with *simple* test cases has been written.  Do a \$ make test to see the results of testing.


\vskip.15in
\noindent\textbf{Auto Grader:} \\
Remember, if you want the auto grader, please add a web hook to: http://coins.csuniv.edu:2234/github/build-csci-315-fall-2016.php in your \textit{forked} repository.
